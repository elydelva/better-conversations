...
export function createSchemaSqlite(prefix = "bc_") {
  const chatters = sqliteTable(`${prefix}chatters`, {
  ...
  const conversations = sqliteTable(`${prefix}conversations`, {
    id: text("id").primaryKey(),
    title: text("title"),
  ...
  const participants = sqliteTable(`${prefix}participants`, {
    id: text("id").primaryKey(),
  ...
  const blocks = sqliteTable(`${prefix}blocks`, {
    id: text("id").primaryKey(),
    conversationId: text("conversation_id")
      .notNull()
      .references(() => conversations.id),
  ...
  const chatterPermissions = sqliteTable(`${prefix}chatter_permissions`, {
    id: text("id").primaryKey(),
    chatterId: text("chatter_id")
      .notNull()
      .references(() => chatters.id),
  ...
  const blockRegistry = sqliteTable(`${prefix}block_registry`, {
  ...
  const roleRegistry = sqliteTable(`${prefix}role_registry`, {
